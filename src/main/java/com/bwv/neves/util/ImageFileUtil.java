...
public class ImageFileUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String ste = ImageFileUtil.ImageToBase64ByOnline(string);

        System.out.println(str);

        ImageFileUtil.Base64ToImage(str, "F:/tsignpdf/test1.jpg");

        ImageFileUtil.Base64ToImage(ste, "F:/tsignpdf/test2.jpg");
    }
