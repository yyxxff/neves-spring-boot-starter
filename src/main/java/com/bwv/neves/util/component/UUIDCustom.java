package com.bwv.neves.util.component;
 ...
 * @since 1.5
 */
public final class UUIDCustom implements java.io.Serializable, Comparable<UUIDCustom> {
     ...
     */
    public UUIDCustom(long mostSigBits, long leastSigBits) {
     ...
     */
    public static UUIDCustom randomUUID() {
        ...
        return new UUIDCustom(randomBytes);
    }
     ...
     */
    public static UUIDCustom nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
        ...
        return new UUIDCustom(md5Bytes);
    }
     ...
     */
    public static UUIDCustom fromString(String name) {
        ...
        return new UUIDCustom(mostSigBits, leastSigBits);
    }
    ...
    public boolean equals(Object obj) {
        if ((null == obj) || (obj.getClass() != UUIDCustom.class))
            return false;
        UUIDCustom id = (UUIDCustom) obj;
     ...
     */
    public int compareTo(UUIDCustom val) {
